        ...
        <div className="grid w-full max-w-6xl gap-4 lg:grid-cols-[1.1fr_0.9fr]">
          <section className="glass-panel rounded-[2.2rem] p-6 md:p-8">
            ...
            <p className="mt-5 max-w-2xl text-base leading-8 text-bapi-evergreen/70">
              BAPI brings together weekly price tracking, trend alerts, and market comparison in one clear platform for farmers, traders, and decision-makers.
            </p>
            <div className="mt-8 grid gap-3 md:grid-cols-3">
              {["Review queued uploads", "Direct CSV import", "Weekly market analytics"].map((item) => (
