...
- report mapping, defense evidence, and submission checklists exist
...
- final screenshots
- final logo assets
- final report writing and Chapter Two citations
- supervisor-specific formatting and submission rules

## Suggested Final Sequence
1. Complete environment setup on your machine.
2. Run smoke checks.
3. Capture screenshots.
4. Finalize the report chapters.
5. Build the defense slides.
6. Rehearse the live demo.
7. Review the submission checklist.
