...
export const submissionsService = {
  async submitPublicUpload(input: PublicUploadInput) {
    ...
    return {
      ...
      failures,
      message:
        "Your upload has been received and placed in the review queue. It will not affect statistics until an admin approves it.",
    };
  },
  ...
  async approve(id: number, reviewedById: number) {
    ...
    if (batch.status !== SubmissionStatus.PENDING) {
